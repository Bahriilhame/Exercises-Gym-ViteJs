...
function App() {
    ...
    function handleSearch(e){
        const exercisesFilter=exercises.filter(ex=>ex.name.toLowerCase().includes(e))
        console.log(exercisesFilter);
        setExercises(exercisesFilter)
    }
  return (
    <>
    <Navbar />
            ...
            <div className="mx-auto flex flex-col items-center py-12 sm:py-24">
                ...
                <div className="flex w-11/12 md:w-8/12 xl:w-6/12">
                    <div className="flex rounded-md w-full">
                        <input onChange={(e)=>handleSearch(e.target.value.toLowerCase())} type="text" name="q"
