    ...
    <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div className="border-b mb-5 flex justify-between text-sm">
            ...
            <select
                ...
                className="w-[30%] h-10 border-2 border-sky-500 focus:outline-none focus:border-sky-500 text-sky-500 rounded px-2 md:px-3 py-0 md:py-1 tracking-wider">
                <option value="All" selected="">Choose a Category</option>
                {filtrage.properties.category.enum.map((c)=>{
                    return (
